 ...
 * The UART must be connected to a CU using the same baud rate as the
 * CU has configured and the hardware flow control pins, CTS and RTS
 * MUST be enabled and connected between CSS and CU.
