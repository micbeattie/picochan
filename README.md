...
Source files include documentation in Doxygen format and there are
some overview markdown pages in Doxygen markdown format rather than
Github markdown format).

A pre-built HTML hierarchy of that documentation is included in this
repository for use as
[online documentation](https://micbeattie.github.io/picochan/html) and so
is the corresponding
[PDF reference manual](https://micbeattie.github.io/picochan/picochan-v0.1-refman.pdf).
...
hobby project unrelated to any IBM business.
